...
class Library:
    def __init__(self):
        ...
        self.books_available: Dict[str: List[str]] = {}  # {"Nakov": ["js", 'python_book']}
        self.rented_books: Dict[str: Dict[str: int]] = {}  # {"Psho": {"Python_basics": 30, "Json" : 20}}
    ...
    def get_book(self, author: str, book_name: str, days_to_return: int, user: User):
        ...
        for data in self.rented_books.values():  # data is dict {"Python" : 30}
